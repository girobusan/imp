...
3. Отредактируйте все, что нужно. В редакторе есть возможность импортировать готовый файл в markdown. Нажмите на большую кнопку "Export HTML"  и сохраните файл *в ту же директорию*. Если вы не переименовывали файл, сохраняйте поверх исходного.
4. Загрузите файлы на сервер, `editor.js` можно не загружать.
5. Всё готово.
